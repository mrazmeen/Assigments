...
public class HttpClient {
    ...
    private static String ip = "localhost", name = "razmeen", port = "8000";
...
//            System.out.println("port: " + port);
            ...
            System.setProperty("javax.net.ssl.trustStore", "src/server.jks");
            System.setProperty("javax.net.ssl.trustStorePassword", "razy07");
            ...
            new Thread(() -> {
                ...
                System.out.println("Find other users, using <list> command ");
                System.out.println("Now you can send messages by send -> <message> receiver name");
                while (true) {
                    System.out.print(":");
